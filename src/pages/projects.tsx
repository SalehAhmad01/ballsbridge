  ...
  const projects = [
    {
      ...
      description:
        "120-unit residential complex delivered in 18 months, 5% under budget.",
    ...
    },
    {
      ...
      category: "Commercial",
      description:
        "15-storey office building with state-of-the-art facilities and green certification.",
      ...
      <div className="container">
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-12">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="overflow-hidden border-border hover:shadow-xl transition-shadow duration-300 group"
            >
